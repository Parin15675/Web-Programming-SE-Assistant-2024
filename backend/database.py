...
async def initialize_curriculums(gmail):
    curriculums = [
        ...
        },
        {
            ...
            "subjects": [
                ...
                {
                    "name": "Networking",
                    "description": "Principles of computer networking, including OSI model, TCP/IP, and network protocols.",
                    "topics": [
                        {"name": "OSI Model", "rating": 0},
                        {"name": "TCP/IP", "rating": 0},
                        {"name": "Network Protocols", "rating": 0}
                    ]
                },
                {
                    "name": "Software Engineering",
                    "description": "Software development methodologies, project management, and quality assurance techniques.",
                    "topics": [
                        {"name": "Agile Methodologies", "rating": 0},
                        {"name": "Software Testing", "rating": 0},
        ...
        },
        {
            ...
            "subjects": [
                ...
                {
                    "name": "AI",
                    "description": "Foundations of artificial intelligence, including knowledge representation and reasoning.",
                    "topics": [
                        {"name": "Knowledge Representation", "rating": 0},
                        {"name": "Search Algorithms", "rating": 0},
                        {"name": "Reasoning", "rating": 0}
                    ]
                },
                {
                    "name": "Cloud Computing",
                    "description": "Study of cloud architecture, services, and deployment models.",
                    "topics": [
                        {"name": "Cloud Architecture", "rating": 0},
                        {"name": "AWS Services", "rating": 0},
                        {"name": "Serverless Computing", "rating": 0}
                    ]
                }
            ]
        }
    ...
    for curriculum in curriculums:
        ...
        print(f"Inserted curriculum for year {curriculum['year']} with ObjectId: {result.inserted_id}") 
